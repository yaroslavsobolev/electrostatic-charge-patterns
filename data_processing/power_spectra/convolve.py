...
def convolve(img, kernel, crop=True, return_fft=False, fftshift=True,
    ...
    *NOTE* Order matters; the kernel should be second.
    ...
    imgquarter1x = int(imgquarter1x)
    imgquarter1y = int(imgquarter1y)
    imgquarter3x, imgquarter3y = centerx + imgshape[0]/2.,centery + imgshape[1]/2.
    imgquarter3x = int(imgquarter3x)
    imgquarter3y = int(imgquarter3y)
    kernelquarter1x, kernelquarter1y = int(centerx - kernshape[0]/2.),int(centery - kernshape[1]/2.)
    kernelquarter3x, kernelquarter3y = int(centerx + kernshape[0]/2.),int(centery + kernshape[1]/2.)
