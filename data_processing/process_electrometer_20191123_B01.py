...
delamination_start_index = int(round(74.1*rps))
...
fig_trace = plt.figure(figsize=(8, 3))
plt.plot(t-t[delamination_start_index]-0.7, sig, label='Original signal', color='C1')
# plt.plot(t-t[delamination_start_index], filtered_sig, linewidth=1, label='Filtered signal')
plt.xlabel('Time, s')
plt.ylabel('Coulomb-meter reading, nC')
plt.xlim(-5, 14)
plt.ylim(-1,9)
plt.tight_layout()
fig_trace.savefig('electrometer_figures/trace_example.png', dpi=300)
